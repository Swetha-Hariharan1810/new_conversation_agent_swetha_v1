...
# Turn 3 AI response is now the name readback; member_id ask follows at turn 4.
_VERIFY_TURNS = {
...
verification_restart_then_success = Scenario(
    ...
    user_turns=[
        ...
        # name_confirmed stays True across restart so the gate does not re-fire
        "emily",
        "carter",
        "m nine zero seven five zero three",
        "April twelfth nineteen eighty-eight",
...
name_confirmation_bare_no_then_gives_name = Scenario(
    ...
    user_turns=[
        ...
        "it's Emma Brown",             # member gives correct name
