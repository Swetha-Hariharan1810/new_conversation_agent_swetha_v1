...
FIELDS
  ...
  first_name  Title Case string
    The corrected first name, when the member declines AND gives the right name inline:
      "no it's Emma", "no, my name is Emma Carter", "actually it's Emma" → Emma
...
Examples:
  ...
  "no it's Emma"                           → first_name="Emma"
  "no, it's Emma Carter"                   → first_name="Emma", last_name="Carter"
  "actually my name is Emma Carter"        → first_name="Emma", last_name="Carter"
  "no that's not right, it's Emma Carter"  → first_name="Emma", last_name="Carter"
  "yes e m i l y c a r t e r"             → name_confirmed="yes"
