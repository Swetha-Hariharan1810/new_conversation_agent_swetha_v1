...
def validate_dob(value: str | None) -> SlotValidationResult:
    ...
    # Validators operate on NORMALIZED values: DOB must be canonical, zero-padded
    # MM/DD/YYYY. A value like "4/12/1988" is not properly normalized and is
    # rejected here (strptime's %m/%d would otherwise leniently accept it).
