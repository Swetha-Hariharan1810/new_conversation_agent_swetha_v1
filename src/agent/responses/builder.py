...
_TRANSITION_TEMPLATES: dict[SlotType, list[str]] = {
    SlotType.LAST_NAME: [
        "Thank you{name_part}. And your last name?",
        "Got it{name_part}. Could I get your last name?",
        "Great{name_part}. What's your last name?",
        "Thank you{name_part}. May I have your last name?",
    ],
    SlotType.MEMBER_ID: [
...
_INITIAL_TEMPLATES: dict[SlotType, list[str]] = {
    ...
    SlotType.PROVIDER_TYPE: [
        ...
        "Are you looking for a primary care physician, a specialist, "
