...
MSG_UPLOAD_OFFER = [
    ...
    "Thank You. I can generate a secure upload link and send it to your email on file. "
    "Would you like me to do that?",
    "Sure. I can send a secure link to your email so you can upload the records yourself. "
...
MSG_PERSONAL_GUIDE_OFFER = [
    ...
    "Would you like us to arrange that?",
...
MSG_NOTIFICATION_BRIDGE = [
    ...
    "I can send you updates as we progress with the outreach. Would you prefer those by email or SMS?",
]
