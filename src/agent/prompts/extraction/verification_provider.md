...
FIELDS
  ...
  relationship  plan holder | subscriber | spouse | myself
                              plan holder / subscriber — caller must say
                              the exact role name. Descriptions → ambiguous.
                              spouse — extract "spouse" for any family or
                              partner reference (wife, husband, son,
                              daughter, partner, parent, child, sibling).
                              myself — extract "myself" for any self-reference.
                              Multiple roles or uncertainty → ambiguous.
