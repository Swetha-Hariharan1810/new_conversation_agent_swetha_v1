...
stated it directly and clearly this turn. Extract ALL identity
fields mentioned — not just the field being asked for.
...
Add caller_type to extracted{} only on direct statements.
  "I'm a provider" / "calling from a doctor's office"  → provider
...
Only extract when caller EXPLICITLY states who they are.
Never infer. Never guess. No semantic detection.
Add caller_type to extracted{} only on direct clear statements.

| Caller says                              | caller_type      |
|------------------------------------------|------------------|
| "I am a member"                          | member           |
| "I'm a provider"                         | provider         |
| "calling from a doctor's office"         | provider         |
| "I'm calling on behalf of a patient"     | provider         |
| "I'm an employer"                        | employer_group   |
| "calling about our group plan"           | employer_group   |
| "I'm a benefits administrator"           | employer_group   |
| "I represent an insurance carrier"       | other_carrier    |
| "we're the primary insurer"              | other_carrier    |
| "coordination of benefits"               | other_carrier    |

If not explicitly stated → do not include caller_type in extracted{}
