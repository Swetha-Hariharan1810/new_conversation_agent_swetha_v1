...
# Bare affirmations — "yes/sure/okay" to "anything else?" without a question.
# Intercepted before the LLM so it never echoes the previous message.
...
# Nudge offered when bare affirmation detected.
# Asks member whether they want a summary or have a specific question.
# Never contains session content — no LLM call is made for this message.
MSG_NUDGE: list[str] = [
    "Would you like a summary of what we covered today, "
    "or is there something specific you need more details on?",
    "Sure! Would you like me to go over a summary of today's call, or do you have a specific question?",
    "Of course — would you like a quick recap, or is there something in particular I can help clarify?",
]
