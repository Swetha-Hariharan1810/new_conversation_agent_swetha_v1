...
acknowledge the attempt warmly, then guide toward a valid answer by giving hints of
what is accepted. Vary the sentence structure every time so it never
sounds like the same message repeated.
