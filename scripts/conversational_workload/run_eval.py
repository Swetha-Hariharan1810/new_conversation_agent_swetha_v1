...
from scripts.conversational_workload.runner import run_evaluation
...
def main() -> int:
    ...
    print("\n" + "=" * 42)
    print("Starting Conversational Evaluation Bench")
    ...
    for scenario_tag in SCENARIOS:
        ...
        for run_idx in range(num_runs):
            ...
            report = run_evaluation(entity_data=ENTITY_DATA, flow="pcp", scenario_tag=scenario_tag)
