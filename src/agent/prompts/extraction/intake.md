...
provider_services — caller wants to find, locate, or get information about an in-network provider, doctor, physician, PCP, or providers within their health plan network.
