...
BENEFITS_OFFER_TEMPLATES = [
    "Since you're calling about a list of in-network providers, would you like to also get the benefits for office visits with your {provider_type}?",
...
FAX_UPDATE_PROMPT   = "Can I get the new fax number, please?"
EMAIL_UPDATE_PROMPT = "Can I get the new email address, please?"
