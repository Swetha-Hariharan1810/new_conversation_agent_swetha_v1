...
## Examples for corrections in the same turn

Caller: "Fax, but I need to update my ZIP code."
Return: extracted delivery_method fax, and correction_target zip_code.

Caller: "Send it to a different fax number."
Return: correction_target fax.

Caller: "Email is fine. Also what about my pharmacy copay?"
Return: extracted delivery_method email, and secondary_intents ["pharmacy"].
